---
url: "https://docs.requesty.ai/models"
title: "Models - Requesty documentation"
---
...
We have more than 150 models available through the router. Log in to the platform to see the most up to date list on the [Model Library Page](https://app.requesty.ai/model-list?provider=cline).You can filter based on price, context window, privacy requirements, to make sure you use the best model for your task.We provide some application-specific models (for example for Cline), see [Dedicated Models](https://requesty.mintlify.app/essentials/dedicated-models) for more information.![Models](https://mintcdn.com/requesty/TcSPqkVK2WsRBepW/images/models.png?fit=max&auto=format&n=TcSPqkVK2WsRBepW&q=85&s=565a2e884607b8a05b98ff3b5c5b58c8)

If there are models or providers that you would like us to add to the platform, please let us know in our [Discord channel](https://discord.com/invite/Td3rwAHgt4).

[Previous](https://docs.requesty.ai/quickstart) [StreamingReceive the response in a stream\\
\\
Next](https://docs.requesty.ai/features/streaming)
