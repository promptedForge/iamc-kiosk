---
url: "https://docs.requesty.ai/api-reference/endpoint/manage-api-key-update-limit"
title: "Update API Key Limit - Requesty documentation"
---
...
```
curl --request POST \
  --url https://api.requesty.ai/v1/manage/apikey/{api_key_id}/limit \
...
[​](https://docs.requesty.ai/api-reference/endpoint/manage-api-key-update-limit#authorization-authorization)
...
[​](https://docs.requesty.ai/api-reference/endpoint/manage-api-key-update-limit#parameter-api-key-id)
...
[​](https://docs.requesty.ai/api-reference/endpoint/manage-api-key-update-limit#body-monthly-limit)
...
[Previous](https://docs.requesty.ai/api-reference/endpoint/manage-api-key-get-usage) [Delete API KeyDelete a specific API key\\
\\
Next](https://docs.requesty.ai/api-reference/endpoint/manage-api-key-delete)
